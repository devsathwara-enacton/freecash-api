...
export async function up(db: Kysely<any>): Promise<void> {
  await db.schema.createTable("offerwall_tasks")
    ...
    .addColumn("network_categories", "longtext")
    .addColumn("network_categories", "text")
    .addColumn("network_goals", "longtext")
